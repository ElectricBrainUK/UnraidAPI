let axios,fs,http;_919‍.x([["getUnraidDetails",()=>getUnraidDetails],["getCSRFToken",()=>getCSRFToken],["changeVMState",()=>changeVMState],["gatherDetailsFromEditVM",()=>gatherDetailsFromEditVM]]);_919‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_919‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_919‍.w("http",[["default",["http"],function(v){http=v}]]);
...
function extractValue(data, value, terminator) {
  ...
  return axios({
    ...
    _919‍.g.console.log(e);
       ...
       function gatherDetailsFromEditVM(ip, id) {
  let rawdata = fs.readFileSync("config/servers.json");
