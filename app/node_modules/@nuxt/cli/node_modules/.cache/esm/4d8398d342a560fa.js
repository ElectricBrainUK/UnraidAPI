let axios,gatherDetailsFromEditVM,getCSRFToken,fs,http;_42a‍.x([["default",()=>_42a‍anonymous]]);_42a‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_42a‍.w("../utils/Unraid",[["gatherDetailsFromEditVM",["gatherDetailsFromEditVM"],function(v){gatherDetailsFromEditVM=v}],["getCSRFToken",["getCSRFToken"],function(v){getCSRFToken=v}]]);_42a‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_42a‍.w("http",[["default",["http"],function(v){http=v}]]);




               function _42a‍anonymous(req, res, next) {
  let body = [];
  let data;
  req.on("data", (chunk) => {
    body.push(chunk);
