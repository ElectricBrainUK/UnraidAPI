let axios,fs,http;_bd5‍.x([["getUnraidDetails",()=>getUnraidDetails],["getCSRFToken",()=>getCSRFToken],["changeVMState",()=>changeVMState],["gatherDetailsFromEditVM",()=>gatherDetailsFromEditVM]]);_bd5‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_bd5‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_bd5‍.w("http",[["default",["http"],function(v){http=v}]]);
...
function extractValue(data, value, terminator) {
  ...
  return axios({
    ...
    _bd5‍.g.console.log(e);
       ...
       function gatherDetailsFromEditVM(ip, id, vmObject) {
  let rawdata = fs.readFileSync("config/servers.json");
  let servers = JSON.parse(rawdata);
  if (!vmObject) {
